document.addEventListener("DOMContentLoaded", function () {
    ...
    const globalMobilePagination = document.querySelector(".global-slider-pagination p");
    ...
    function updateMobilePagination(index) {
        ...
        if (globalMobilePagination) {
            globalMobilePagination.textContent = `${String(index + 1).padStart(2, '0')} / ${String(totalSlides).padStart(2, '0')}`;
        }
    }
